...
- Delegation rule: do not satisfy host-code requests locally when the relay path is intended; report relay failures instead of substituting a local implementation
